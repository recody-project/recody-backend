...
public class Recody {
    ...
    public static final String BOOK_TASK_EXECUTOR = "book-task-executor";
    ...
    public static final String MOVIE_GENRE_PREFIX = "mg-";
    public static final String MUSIC_GENRE_PREFIX = "mug-";
